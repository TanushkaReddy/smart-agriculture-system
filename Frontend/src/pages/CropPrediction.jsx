...
export default function CropPrediction(){
  ...
  // ✅ FIX 1: Stable scroll for hash navigation + reload
  useEffect(() => {
  ...
  // ✅ FIX 2: Safe scroll function for button click
  const scrollToForm = () => {
        ...
        <div className="space-y-6">
          ...
          <div className="premium-card bg-slate-950/90 border-slate-800/60">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-300">
                  Your AI-driven crop guidance appears here.
                </p>
              </div>

              <span className="rounded-full bg-emerald-500/10 px-3 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-300 border border-emerald-500/20">
                Smart output
              </span>
            </div>
            ...
            {!loading && result && (
              <ResultCard
                ...
                result={result}
                details="Apply local validation and irrigation recommendations for best yield."
              />
            )}

            {!loading && !result && (
              <div className="mt-6 text-slate-600 dark:text-slate-400">
                Complete the form to see a personalized crop recommendation.
              </div>
            )}
          ...
          <div className="premium-card bg-slate-950/90 border-slate-800/60">
            ...
            <p className="mt-3 text-slate-300">
              The model analyzes soil nutrient levels, temperature, humidity and rainfall to recommend the crop most likely to thrive.
            </p>
